...
<html class="no-js" lang="en">
    <head>
        ...
        <title> Park Fast &nbsp;|&nbsp;<?php echo (isset($titulo) ? $titulo : 'Um novo conceito em estacionamentos') ?></title>
        ...
        <!-- Caso precise no futuro retiro o comentario
        ...
        <!-- foreach para carregar o array de estilos do css  --> 
        <?php if(isset($styles)): ?>
