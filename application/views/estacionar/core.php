  ...
  <?php $this->load->view('layout/sidebar')?>;
        ...
        <div class="main-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header"><?php echo(isset($estacionado) ? '<i class="ik ik-calendar ik-2 x"></i> &nbsp; Data da ultima alteração:&nbsp; ' .formata_data_banco_com_hora( $estacionado->estacionar_data_alteracao) : ''); ?></div>
                        <div class="card-body">
